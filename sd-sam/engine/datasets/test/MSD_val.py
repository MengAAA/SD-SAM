...
class MSD_VALDataset(BaseInterSegDataset):

    METAINFO = dict(
        classes = ('good', 'defect'),
        palette = [[0, 0, 0], [255, 0, 0]]
    )
    default_meta_root = 'data/meta-info/MSD_val_mvtec.json'
    ...
    def load_data_list(self):
        ...
        img_root = Path(self.data_root+'/images')
        ann_root = Path(self.data_root + '/masks')
